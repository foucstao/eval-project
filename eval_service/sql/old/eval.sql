...
INSERT INTO `eval_node_evaluation` VALUES (1,'workshop','worker1','high',0.6,NULL),(2,'workshop','mac1','high',0.7,NULL),(3,'workshop','mac1','low',0.25,NULL),(4,'workshop','worker1mac2','low',0.55,NULL),(5,'workshop','worker1','low',0.4,NULL),(6,'workshop','mac1','medium',0.15,NULL),(7,'workshop','worker1mac2','high',0.45,NULL);
...
INSERT INTO `eval_node_index` VALUES (1,'workshop','worker1','Certificate',0.8,'high',NULL,NULL),(2,'workshop','mac1','MacState',NULL,'high',NULL,NULL),(3,'workshop','mac1','LifeTime',NULL,'low',NULL,NULL),(4,'workshop','worker1mac2','CheckTimes',NULL,'low',NULL,NULL),(5,'workshop','worker','Certificate',NULL,NULL,NULL,NULL),(6,'workshop','machine','Certificate',NULL,NULL,NULL,NULL),(7,'workshop','workermachine','Certificate',NULL,NULL,NULL,NULL);
...
INSERT INTO `eval_obj_evaluation` VALUES (1,'workshop','high',0.5,NULL),(2,'workshop','medium',0.3,NULL),(3,'workshop','low',0.2,NULL),(4,'product1','high',0.7,NULL),(5,'product1','medium',0.2,NULL),(6,'product1','low',0.1,NULL),(7,'workshop2','high',0.6,NULL);
...
--
-- Table structure for table `evalobj_node_index_link`
--

DROP TABLE IF EXISTS `evalobj_node_index_link`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `evalobj_node_index_link` (
  `id` int NOT NULL AUTO_INCREMENT,
  `eval_obj_code` varchar(100) NOT NULL,
  `node_code` varchar(100) NOT NULL,
  `index_code` varchar(100) DEFAULT NULL,
...
--
-- Dumping data for table `evalobj_node_index_link`
--

LOCK TABLES `evalobj_node_index_link` WRITE;
/*!40000 ALTER TABLE `evalobj_node_index_link` DISABLE KEYS */;
INSERT INTO `evalobj_node_index_link` VALUES (1,'workshop','worker1','Certificate',12),(2,'workshop','mac1','LifeTime',14),(3,'workshop','mac1','numberOfFailure',2),(4,'workshop','worker',NULL,NULL),(5,'workshop','machine',NULL,NULL),(6,'workshop','workermachine',NULL,NULL);
/*!40000 ALTER TABLE `evalobj_node_index_link` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `evalobj_node_link` VALUES (1,'workshop','worker1','工人1','WORKER'),(2,'workshop','mac1','机器1','MACHINE'),(3,'workshop','worker1mac2','工人1机器2','WORKER-MACHINE'),(4,'workshop','worker','工人','WORKER'),(5,'workshop','machine','机器','MACHINE'),(6,'workshop','workermachine','工人机器','WORKER-MACHINE');
...
INSERT INTO `index_membership` VALUES (1,'LifeTime','high','gauss',0,1,NULL,NULL,NULL,NULL),(2,'LifeTime','low','gauss',0.5,0.5,NULL,NULL,NULL,NULL);
...
INSERT INTO `nodetype_index_link` VALUES (1,'MACHINE','LifeTime','v1'),(2,'MACHINE','numberOfFailure','v1'),(3,'WORKER','Certificate','v1');
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=86 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='菜单列表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_menu` VALUES (3,'dd','系统管理',0,'Setting','0',NULL,1,0),(4,'system/Menus','菜单管理',3,'Menu','1',NULL,1,0),(5,'system/Roles','角色管理',3,'HelpFilled','1','sys:role',2,0),(33,'system/Users','用户管理',3,'UserFilled','1','system:user:list',3,0),(41,'base','基础管理',0,'Calendar','0','',2,0),(42,'blacklist','黑名单记录',41,'ios-aperture','0','base:black:list',1,0),(45,'system/DictType','字典管理',3,'DataAnalysis','1','sys:dict:list',4,0),(46,'blacklist','白名单记录',42,'ios-aperture','1','base:black:list',1,0),(52,'genCode','代码生成',3,'Menu','1','ss',1,0),(54,'personCenter','个人中心',0,'Stamp','1','sd',3,0),(56,'','新增',5,'Menu','2','sys:role:add',1,0),(61,'','测试目录',0,'FullScreen','0','',1,0),(63,'','编辑',5,'Menu','2','sys:role:edit',1,0),(64,'system/SysTest-ele','测试管理',61,'TakeawayBox','1','',1,0),(65,'','新增',64,'Menu','2','sysy',1,0),(66,'','删除不',64,'Menu','2','222',1,0),(67,'','sdf',46,'Menu','2','岁的法国',1,0),(68,'','是德国',46,'Menu','2','dfg',1,0),(69,'system/SysVideo','视频管理',61,'View','1','sss',1,0),(70,'','态势评估',0,'Menu','0','',1,0),(71,'eval/evalObjMgmt','评估对象管理',70,'Avatar','1','',6,0),(72,'eval/evalNodeDef','评估节点管理',70,'Aim','1','',3,0),(73,'eval/indexDef','评估指标管理',70,'Compass','1','',4,0),(75,'eval/commitLevelDef','评级评语设计',70,'CircleCheck','1','',5,0),(77,'#','模型评价输出',70,'CircleCheck','1',NULL,7,0),(78,'eval/nodeTypeDef','节点类型设计',70,'Menu','1','',2,0),(79,'404','评估对象节点',70,'Menu','1','',6,0),(80,'eval/test','隶属度参数',70,'Menu','1','',5,0),(81,'404','指标权重设置',70,'Menu','1','',4,0),(83,'404','评估节点指标',70,'Menu','1','',6,0),(84,'404','指标值输入',70,'Menu','1','',6,0),(85,'404','上游系统接口',70,'Menu','1','',6,0);
...
-- Dump completed on 2023-10-11 19:12:48
