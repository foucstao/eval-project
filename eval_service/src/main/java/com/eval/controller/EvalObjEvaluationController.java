...
import com.eval.service.EvalObjEvaluationService;

@RestController
@RequestMapping("api/eval/objEval")
public class EvalObjEvaluationController extends BaseAPIController {

	@Autowired
	EvalObjEvaluationService indexService;

	@GetMapping("/obj/{obj}")
	public APIReturnData getNodesByObj(@PathVariable String obj) {
		List<EvalObjEvaluation> indexes = indexService.selectByObj(obj);
	...
	public APIReturnData getNodesByInstance(@PathVariable String evalInstance) {
		List<EvalObjEvaluation> indexes = indexService.selectByInstance(evalInstance);
		APIReturnData apiReturnData = new APIReturnData();
		apiReturnData.success();
		apiReturnData.putData("total", indexes.size());
		apiReturnData.putData("tableList", indexes);
	...
	@PostMapping("/add")
	public APIReturnData add(@Validated @RequestBody EvalObjEvaluation indexobj) {
	...
	@PutMapping("/edit")
	public APIReturnData edit(@Validated @RequestBody EvalObjEvaluation indexobj) {
